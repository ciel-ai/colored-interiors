  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      <div className="grid leading-none">
        <div className={`font-serif text-[1.7rem] tracking-tight ${base}`}>
          <span>colo</span>
          <span className={accent}>r</span>
          <span>ed</span>
        </div>
        <div className={`mt-0.5 flex justify-between text-[0.55rem] font-medium uppercase tracking-wide ${sub}`}>
          <span>Interior</span>
          <span>Designs</span>
        </div>
      </div>
